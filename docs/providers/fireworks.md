...
Create a key at [Fireworks](https://fireworks.ai/account/api-keys). Paste it on Models → Popular services → Fireworks AI (cog). Keys live in SQLite, not env.

## Enable

1. Open Models
2. Popular services → Fireworks AI → cog
