...
- `$BROS_HOST_DATA_DIR/opencode/workspace` → `/workspace`
- `$BROS_HOST_DATA_DIR/opencode/root/.config/opencode` → `/root/.config/opencode`
- `$BROS_HOST_DATA_DIR/opencode/root/.local/share/opencode` → `/root/.local/share/opencode`
